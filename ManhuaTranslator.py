...
class ManhuaTranslator():
    ...
    def manhua_translation(self, image_PIL:Image,input_boxes:list, input_point:np.array)->dict:
        """
    ...
    def paddings(line_words:list, line_words_shape:list, pad_proportion:float = 0.1)->list:
        """
